...
class Driver {
  ...
  static const String sendBookingAccept = "http://$headPoint:$port/acceptBookingRequest";
  static const String sendSMS = "http://$headPoint:$port/sendSMS";
  static const String sendNotification = "http://$headPoint:$port/sendNotification";
  static const String setCompleted = "http://$headPoint:$port/setCompleted";
}

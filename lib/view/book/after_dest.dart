...
class AfterDestination extends StatefulWidget {
  ...
  @override
  State<AfterDestination> createState() => _AfterDestinationState();
}



class _AfterDestinationState extends State<AfterDestination> {
        ...
        child: Column(children: [
          ...
          Row(children: [
            ...
            Expanded(child: Column(children: [
              ...
              InfoText( title: "Giá thành: ", detail: "${widget.price} VNĐ" ),
              const HorizontalLine(),
              InfoText( title: "Thời gian: ", detail: durationToString(widget.duration) ),
              const HorizontalLine(),
              InfoText( title: "Quãng đường: ", detail: distanceToString(widget.distance) ),
            ])),
          ...
          SizedBox(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              BigButton(
                ...
                width: 170,
                bold: true,
                color: widget.userController.account.map["isVip"] ? Colors.amber.shade700 : Colors.brown.shade700,
                onPressed: () async => pickTime(),
                pressable: true // widget.userController.account.map["isVip"]
              ),
            ])

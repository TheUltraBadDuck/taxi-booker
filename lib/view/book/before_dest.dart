...
class BeforeDestination extends StatefulWidget {
  const BeforeDestination({ Key? key, required this.userController, required this.vehicleID, required this.onSubmitted }) : super(key: key);
  final UserController userController;
  final int vehicleID;
  final Function(PickedData value) onSubmitted;

  @override
  State<BeforeDestination> createState() => _BeforeDestinationState();
}



class _BeforeDestinationState extends State<BeforeDestination> {
